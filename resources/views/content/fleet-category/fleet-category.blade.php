...
@section('page-script')
<script src="{{ asset('assets/js/fleet-category/fleet-category.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/fleet-category/modal-add-category.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/fleet-category/modal-edit-category.js') }}?v={{ time() }}"></script>
@endsection

@section('content')

  <div class="d-flex justify-content-between align-items-center title-head">
      <h5 class="mb-2">Master Data > Fleet Category</h5>
          ...
          <table id="main-table" class="datatables-main table border-top" style="width: 100%;">
              <thead>
                  <tr>
                    ...
                    <th class="text-uppercase white-space-nowrap">Category Name</th>
...
@include('_partials/_modals/fleet-category/modal-add-category')
@include('_partials/_modals/fleet-category/modal-edit-category')

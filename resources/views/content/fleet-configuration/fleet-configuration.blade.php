...
@section('page-script')
<script src="{{ asset('assets/js/fleet-configuration/fleet-configuration.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/fleet-configuration/modal-add-type.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/fleet-configuration/modal-edit-type.js') }}?v={{ time() }}"></script>
@endsection

@section('content')

  <div class="d-flex justify-content-between align-items-center title-head">
      <h5 class="mb-2">Master Data > Fleet Configuration</h5>
          ...
          <table id="main-table" class="datatables-main table border-top" style="width: 100%;">
              <thead>
                  <tr>
                        ...
                        <th class="text-uppercase white-space-nowrap">Type</th>
                        <th class="text-uppercase white-space-nowrap">Name</th>
                        <th class="text-start text-uppercase white-space-nowrap">Setting</th>
                        <th class="text-center text-uppercase white-space-nowrap">Photo</th>
                        <th class="text-uppercase text-center white-space-nowrap" style="width: 70px;">Actions</th>
                  </tr>
              </thead>
              <tbody>
              </tbody>
...
@include('_partials/_modals/fleet-configuration/modal-add-type')
@include('_partials/_modals/fleet-configuration/modal-edit-type')

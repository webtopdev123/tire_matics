...
@section('page-script')
<script src="{{ asset('assets/js/fleet-segment/fleet-segment.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/fleet-segment/modal-add-segment.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/fleet-segment/modal-edit-segment.js') }}?v={{ time() }}"></script>
@endsection

@section('content')

  <div class="d-flex justify-content-between align-items-center title-head">
      <h5 class="mb-2">Master Data > Fleet Segment</h5>
          ...
          <table id="main-table" class="datatables-main table border-top" style="width: 100%;">
              <thead>
                  <tr>
                    ...
                    <th class="text-uppercase white-space-nowrap">Segment Name</th>
...
@include('_partials/_modals/fleet-segment/modal-add-segment')
@include('_partials/_modals/fleet-segment/modal-edit-segment')

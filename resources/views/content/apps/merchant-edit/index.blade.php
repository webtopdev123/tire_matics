...
@section('page-script')
    <script src="{{ asset('assets/js/merchant-edit/app-merchant.js') }}?v={{ time() }}"></script>
@endsection

@section('content')
    <div class="d-flex justify-content-between align-items-center title-head">
        <h4 class="mb-2">Setting > Edit Merchant</h4>
    </div>
    ...
    <!-- Edit Role Modal -->
    @include('_partials/_modals/merchant-edit/modal-edit-merchant')
    <!-- / Edit Role Modal -->
@endsection

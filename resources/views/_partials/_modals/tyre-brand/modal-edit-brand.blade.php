    ...
    <div class="modal-content p-3 p-md-5 pb-md-0 pt-md-2">
      ...
      <div class="modal-body pb-md-4">
        <div class="text-center mb-4">
          <h3 class="mb-2">Update Brand</h3>
        </div>
        <form class="row" onsubmit="return false">
          <input name="brand_id" hidden />
          <div class="col-12 mb-3">
            <label class="form-label" style="font-weight:bold;">Brand Name</label>
            <input type="text" name="brand_name" class="form-control" placeholder="Brand Name" autofocus />
          </div>

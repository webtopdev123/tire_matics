      ...
      <div class="modal-body pb-md-4">
        ...
        <form class="row" onsubmit="return false">
          ...
          <div class="col-12 mb-3">
            <label class="form-label" for="edit_product_parent_category">Parent Category</label>
            <select id="edit_product_parent_category" class="select2 form-select" name="parent_id">

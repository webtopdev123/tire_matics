...
jQuery(function () {
  ...
  $('#main-table tbody').on('click', '.btnModels', function () {
    ...
    current_brand_id = data['brand_id'];
    console.log(data);
        ...
        response.data.forEach((e, i) => {
          tableBody += `
                        <tr>
                            ...
                            <td class="text-left">${e['model_name']}</td>
                            <td class="" style="white-space: nowrap;">
                              <button class="btn btn-primary btnSizes" id="size_id-${e['model_id']}"  data-object='${JSON.stringify(e).replace(/'/g, "&#39;")}'>Sizes</button>
                              <button class="btn btn-sm btn-icon btnUpdate" data-object='${JSON.stringify(e).replace(/'/g, "&#39;")}'><i class="ti ti-edit"></i></button>
                              <button class="btn btn-sm btn-icon btnDelete" data-id="${e['model_id']}"><i class="ti ti-trash"></i></button>
                            </td>
                        </tr>`;
        });
